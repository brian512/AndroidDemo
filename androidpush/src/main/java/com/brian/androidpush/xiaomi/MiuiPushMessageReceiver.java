package com.brian.androidpush.xiaomi;
...
import com.brian.androidpush.utils.RomUtil.Target;
...
//                result.setExtra(JsonUtils.setJson(message.getExtra()).toString());
                ...
                LogUtil.i("onReceivePassThroughMessage: " + e.toString());
                result.setExtra("{}");
            }
