...
package com.togic.plugin.download;
 ...
 * superclass. Author : Avinash Lakshman ( alakshman@facebook.com) & Prashant
 * Malik ( pmalik@facebook.com )
 */
...
public final class BufferedRandomAccessFile extends RandomAccessFile {
     ...
     * @author brian
     */
    public long getWritenPosition() {
        if (!dirty_) {
            return this.diskPos_;
        } else {
            return this.lo_;
        }
    }
