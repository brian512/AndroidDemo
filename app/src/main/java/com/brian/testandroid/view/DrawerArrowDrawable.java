...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        mSize = dip2px(context, 20);
        setGapSize(dip2px(context, 5));
        setBarThickness(dip2px(context, 2));
        mBarLength = mSize;
        mArrowShaftLength = mSize;
        mArrowHeadLength = mSize/2;
...
//        a.recycle();
    ...
    private boolean mIsCirculate = true;
    private boolean flipped = false;
    
    /**
     * 设置是否一直顺时针旋转，默认值为true，false则顺时针逆时针交替
     * @param isCirculate
     */
    public void setCirculate(boolean isCirculate) {
        mIsCirculate = isCirculate;
    }
